...
1. Установите зависимости:
   ...
   ```
2. Создайте `config.yaml`, указав токен авторизации, сопоставление имён артистов с их ID и пресеты для каждого артиста (лейбл, жанр и другие значения).
...
Для полей `composers` и `lyricists` теперь доступен поиск по имени: начните вводить фамилию или псевдоним, выберите варианты из списка и их ID будут сохранены в `config.yaml`.
